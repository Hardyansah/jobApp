                ...
                <div class="card shadow mb-2">
                    <div class="card-header py-4">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="user_id" id="user_id" class="input" value="{{$currentUser->id}}">
                        </div>

                        <div class="form-group">
                            <label for="name" class="label">Nama</label>
                            <input type="name" name="name" id="name" class="form-control" value="{{$currentUser->name}}" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" id="email" class="form-control" value="{{$currentUser->email}}" disabled>
                ...
                <div class="card shadow mb-2">
                    <div class="card-header py-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="file" id="file" autofocus="true" class="form-control-file border">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="poto" id="poto" autofocus="true" class="form-control-file border">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" name="no_telp" id="no_telp" autofocus="true" class="form-control">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" name="sekolah" id="sekolah" autofocus="true" class="form-control">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" name="jurusan" id="jurusan" autofocus="true" class="form-control">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" name="alamat_sekolah" id="alamat_sekolah" autofocus="true" class="form-control">
