...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-4">
            ...
            <form action="{{route('user.update', $currentUser->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card shadow mb-2">
                    <div class="card-header py-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" name="name" id="name" class="form-control" value="{{$currentUser->name}}">
                ...
                <div class="card shadow mb-2">
                    <div class="card-header py-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="alamat" cols="20" rows="10" class="form-control">value="{{$detail->alamat}}"</textarea>
