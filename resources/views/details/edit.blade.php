...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-4">
            ...
            <form action="{{route('details.update', $currentUser->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card shadow mb-2">
                    <div class="card-header py-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="age" id="age" class="form-control" value="{{$currentUser->age}}">
